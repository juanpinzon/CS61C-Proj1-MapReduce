...
proj1: classes
	$(JAVAC) -d classes Proj1.java DoublePair.java Func.java

proj1-out: $(TARGET)
	rm -rf dir-*
	hadoop jar proj1.jar Proj1 -conf conf.xml -Dcombiner=true -DrunJob2=true ~cs61c/data/sample.seq dir-int/ dir-out/
